            ...
            <div class="p-8 bg-gray-100 rounded-lg description">
                ...
                {{-- <ol class="pl-4 list-decimal list-inside">
                    ...
                    <li class="mb-2"><strong>Javítások:</strong> Az elöregedett sziloplasztot el kell távolítani. Kiesett
                        fugaanyag, valamint
                        a nem kívánt lyukak, kisebb hibák javítása HARZO-Fix Kiegyenlítő és tömítőanyaggal, illetve a
                        HARZO-Fix
                        javító tapasszal javítható. A festés megkezdése előtt, a megszáradt kisebb javítások, lyukak
                        felületét
                    ...
                    <li class="mb-2"><strong>Lakkozás:</strong> HARZO kétkomponensű vizes lakkal, két rétegben Száradási
                        idő:
                        kb.2-3 óra, ami
                        függ a levegő hőmérséklettől és a szellőztetés lehetőségeitől.</li>
                    <li class="mb-2"><strong>Ápolás:</strong> HARZO Fényesítő-Ápolóval két rétegben. Rétegek közötti
                        száradási
                        idő: kb. 30-40
